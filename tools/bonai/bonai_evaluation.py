...
def parse_args():
    ...
    parser.add_argument(
        '--model',
        type=str,
        default='cascade_loft_r50_fpn_3x', 
        help='full model name for evaluation')
    parser.add_argument(
        '--city',
        type=str,
        default='shanghai_xian', 
...
class EvaluationParameters:
    def __init__(self, city, model):
        ...
        self.dataset_root = "/config_data/BONAI_data/BONAI-20230403T091731Z-002/BONAI"
        self.csv_groundtruth_root = "/config_data/BONAI_data"
        self.pred_result_root = "./work_dirs"

        # dataset file
        self.anno_file = f'/config_data/BONAI_data/BONAI-20230403T091731Z-002/BONAI/coco/bonai_shanghai_xian_test.json'
        self.test_image_dir = f'/config_data/BONAI_data/BONAI-20230403T091731Z-002/BONAI/test/test'

        # csv ground truth files
        self.gt_roof_csv_file = f'/config_data/BONAI_data/csv/shanghai_xian_v3_merge_val_roof_crop1024_gt_minarea500.csv'
        self.gt_footprint_csv_file = f'/config_data/BONAI_data/csv/shanghai_xian_v3_merge_val_footprint_crop1024_gt_minarea500.csv'

        # detection result files
        self.mmdetection_pkl_file = f'./cascade_loft_r50.pkl'
...
if __name__ == '__main__':  
    ...
    eval_parameters.with_offset =True
